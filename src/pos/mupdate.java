...
class mupdate  implements ActionListener,ItemListener
{
JFrame f;
Panel p;
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
 ...
 PreparedStatement  ps = con.prepareStatement("update mprofile  set Location=? , E_Mail_Id=? ,Contact_No =?, Address=?, D_O_B=?,Gender=?, Password=?, Manager_Id=?,manager_father=?,manager_name=? where  Manager_Id='"+y+"'  ");
