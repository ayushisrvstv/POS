...
class Aupdate  implements ActionListener,ItemListener
{
JFrame f;
Panel p;
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
 ...
 PreparedStatement  ps = con.prepareStatement("update aprofile  set Location=? ,E_Mail_Id=? ,Contact_No =?, Address=?, D_O_B=?,Gender=?, Password=?, Admin_Id=?,father_name=?,admin_name=? where  Admin_Id='"+y+"'  ");
