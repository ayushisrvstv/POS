...
class muvendor  implements ActionListener
{
...
l3= new 
Label("_______________________________________________________________________________________________________________________________________________________________________________");

l4= new Label("Update Vendor Form");
...
l8= new Label("Contact_Person_Name");
...
String y5= t5.getText();
 ...
 try
 {
String y = t6.getSelectedItem();
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
    Connection  con = DriverManager.getConnection("jdbc:odbc:raman1");

 PreparedStatement  ps = con.prepareStatement("update cvendor  set Company_Name=? , Product_Name=? ,Contact_Person_Name =?,Contact_No=?, E_Mail_Id=?    where  Contact_Person_ID='"+y+"'  ");
