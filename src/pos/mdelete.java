...
class mdelete  implements ActionListener
{
...
l4= new Label("Select Manager_Id");
//t1 = new TextField();
   ...
   try
     {
        ...
        while(rs.next())
        {
           ...
           {
               i = i+1;
                  PreparedStatement ps=con. prepareStatement("delete from mprofile   where  Manager_Id='"+data+"'  ");          
                     ps.executeUpdate();
