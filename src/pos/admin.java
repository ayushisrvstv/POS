...
JFrame f;
Panel p;
Label l1,l2,l3,l4,l5,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16;
TextField t2,t3,t4,t6,t7,t8,t9,t10,t11,t12;
...
l15= new 
Label("_____________________________________________________________________________________________________________________________________");
...
t4.setBounds(300,350,60,30);
l7.setBounds(100,400,100,30);
t12.setBounds(300,400,150,30);
...
l10.setBounds(100,550,150,30);
t8.setBounds(300,550,150,30);
l11.setBounds(100,600,120,30);
t9.setBounds(300,600,150,30);

l12.setBounds(100,650,100,30);
t10.setBounds(300,650,150,30);
l12.setBounds(100,650,150,30);
...
public void actionPerformed(ActionEvent ae)
{
    ...
    Connection  con = DriverManager.getConnection("jdbc:odbc:raman1");
       Statement  stm =con.createStatement();
       ResultSet  rs = stm.executeQuery("select * from aprofile  where Admin_Id='"+data+"' ");
       while(rs.next())
       {
