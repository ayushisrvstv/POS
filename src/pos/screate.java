...
class screate implements ActionListener,ItemListener
{
JFrame f;
Panel p;
...
l14=new Label("Create Salesperson Profile");
...
l14.setBounds(150,150,400,30);

l15.setBounds(150,170,370,20);
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
    ...
    String ins="insert into sprofile(salesman_name,salesman_father,Salesperson_Id,Password,Gender,D_O_B,Address,Contact_No,E_Mail_Id,Location) values(?,?,?,?,?,?,?,?,?,?)";
